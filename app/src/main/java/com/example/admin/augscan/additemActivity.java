...
public class additemActivity extends AppCompatActivity {
    ...
    String[] spinnerOptions = {"Electronic", "Home-Kitchen", "Mobile","Clothes"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // String result = finaluser.substring(0, finaluser.indexOf("@"));
        ...
        Spinner item = (Spinner) findViewById(R.id.editcategory);
        ...
        item.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                String first=spinnerOptions[i].toString();
            }
...
public  void additem(){
        ...
        String itemcategoryValue =itemcategory.toString();
